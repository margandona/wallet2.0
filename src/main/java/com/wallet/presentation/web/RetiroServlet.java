...
/**
 * Web controller for withdrawals.
 */
...
public class RetiroServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            TransaccionDTO transaccion = cuentaService.retirarPorNumero(
            ...
            request.setAttribute("success", "Retiro realizado.");
        } catch (Exception e) {
            request.setAttribute("error", e.getMessage());
        }
    ...
    private void forward(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/retiro.jsp");
